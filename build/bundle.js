...
var app = (function () {
	...
	const file$3 = "src/Navigation.svelte";
	...
	function create_fragment$3(ctx) {
		...
		const block = {
			c: function create() {
				...
				t7 = space();
				p4 = element("p");
				p4.textContent = "About";
				add_location(p0, file$3, 1, 1, 19);
				add_location(p1, file$3, 2, 1, 32);
				add_location(p2, file$3, 3, 1, 49);
				add_location(p3, file$3, 4, 1, 61);
				add_location(p4, file$3, 5, 1, 76);
				set_custom_element_data(navigation_svlt, "class", "svelte-1wwirtp");
				add_location(navigation_svlt, file$3, 0, 0, 0);
			},
			...
			m: function mount(target, anchor) {
				...
				append_dev(navigation_svlt, p0);
				append_dev(navigation_svlt, t1);
				append_dev(navigation_svlt, p1);
				append_dev(navigation_svlt, t3);
				append_dev(navigation_svlt, p2);
				append_dev(navigation_svlt, t5);
				append_dev(navigation_svlt, p3);
				append_dev(navigation_svlt, t7);
				append_dev(navigation_svlt, p4);
			},
			p: noop,
			i: noop,
			o: noop,
	...
	const file$2 = "src/sections/Home.svelte";
	...
	function create_fragment$2(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(section_svlt, file$2, 0, 0, 0);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function create_fragment$1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(section_svlt, file$1, 4, 0, 63);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(main, file, 15, 0, 320);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function instance($$self, $$props, $$invalidate) {
		...
		$$self.$capture_state = () => ({ onMount, Navigation, Home, Projects });
		return [];
	}
