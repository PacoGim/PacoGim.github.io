...
var app = (function () {
	...
	function create_fragment$6(ctx) {
		...
		const block = {
			c: function create() {
				...
				set_custom_element_data(navigation_svlt, "class", "svelte-1wwirtp");
	...
	function create_fragment$5(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(section_svlt, file$5, 12, 0, 323);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
			m: function mount(target, anchor) {
				...
				/*section_svlt_binding*/ ctx[2](section_svlt);
			},
			p: noop,
			i: noop,
			o: noop,
			d: function destroy(detaching) {
				...
				/*section_svlt_binding*/ ctx[2](null);
			}
		};
	...
	function instance$5($$self, $$props, $$invalidate) {
		...
		component_subscribe($$self, windowScrollValueStore, $$value => $$invalidate(1, $windowScrollValueStore = $$value));
		let { $$slots: slots = {}, $$scope } = $$props;
		...
		$$self.$$.update = () => {
			if ($$self.$$.dirty & /*selfElement, $windowScrollValueStore*/ 3) {
				if (selfElement) {
		...
		return [selfElement, $windowScrollValueStore, section_svlt_binding];
	}
	...
	function create_fragment$4(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(section_svlt, file$4, 13, 0, 365);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function create_fragment$3(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(section_svlt, file$3, 12, 0, 321);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function instance$3($$self, $$props, $$invalidate) {
		...
		let $windowScrollValueStore;
		validate_store(bioSectionFontWeight, 'bioSectionFontWeight');
		component_subscribe($$self, bioSectionFontWeight, $$value => $$invalidate(3, $bioSectionFontWeight = $$value));
		validate_store(windowScrollValueStore, 'windowScrollValueStore');
		component_subscribe($$self, windowScrollValueStore, $$value => $$invalidate(1, $windowScrollValueStore = $$value));
		let { $$slots: slots = {}, $$scope } = $$props;
	...
	function create_fragment$2(ctx) {
		...
		const block = {
			c: function create() {
				...
				set_custom_element_data(section_svlt, "class", "svelte-11rhy0u");
				add_location(section_svlt, file$2, 13, 0, 388);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function create_fragment$1(ctx) {
		...
		const block = {
			c: function create() {
				...
				set_custom_element_data(section_svlt, "class", "svelte-11rhy0u");
				add_location(section_svlt, file$1, 12, 0, 352);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function instance$1($$self, $$props, $$invalidate) {
		...
		let $windowScrollValueStore;
		validate_store(aboutSectionFontWeight, 'aboutSectionFontWeight');
		component_subscribe($$self, aboutSectionFontWeight, $$value => $$invalidate(3, $aboutSectionFontWeight = $$value));
		validate_store(windowScrollValueStore, 'windowScrollValueStore');
		component_subscribe($$self, windowScrollValueStore, $$value => $$invalidate(1, $windowScrollValueStore = $$value));
		let { $$slots: slots = {}, $$scope } = $$props;
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(main, file, 19, 0, 565);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function instance($$self, $$props, $$invalidate) {
		let $windowScrollValueStore;
		validate_store(windowScrollValueStore, 'windowScrollValueStore');
		component_subscribe($$self, windowScrollValueStore, $$value => $$invalidate(0, $windowScrollValueStore = $$value));
		let { $$slots: slots = {}, $$scope } = $$props;
